...
![코딩 에이전트는 자동완성에서 작업 위임으로 넘어간다](assets/260430_ai-coding-agent-workflow/hero.svg)
...
![요구사항에서 리뷰까지 이어지는 코딩 에이전트 루프](assets/260430_ai-coding-agent-workflow/workflow-loop.svg)
...
![Planner, Generator, Evaluator 역할 분리](assets/260430_ai-coding-agent-workflow/role-split.svg)
...
![실무 조직 개발 workflow에 코딩 에이전트를 넣는 방식](assets/260430_ai-coding-agent-workflow/org-application.svg)
