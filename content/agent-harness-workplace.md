...
![모델보다 하네스 레이어가 먼저다](assets/260430_agent-harness-layer/hero.svg)
...
![에이전트 런타임은 여러 층으로 구성된다](assets/260430_agent-harness-layer/runtime-stack.svg)
...
![실패 로그와 checkpoint가 다음 실행의 컨텍스트가 된다](assets/260430_agent-harness-layer/failure-loop.svg)
