...
![RAG는 PDF에서 답변까지 이어지는 파이프라인이다](assets/260430_rag-parsing-evaluation/hero.svg)
...
![표 기반 문서는 row, header, cell provenance를 같이 보존해야 한다](assets/260430_rag-parsing-evaluation/table-chunking.svg)
...
![RAG 평가는 retrieval, citation, faithfulness, failure handling으로 나눠야 한다](assets/260430_rag-parsing-evaluation/eval-layers.svg)
